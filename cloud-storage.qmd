...
This chapter requires `targets` version 1.2.2.9002 or higher. Please visit the [installation instructions](https://docs.ropensci.org/targets/#installation).
:::
...
1. `tar_make()` uploads target data to a cloud bucket *instead of* the local [`_targets/objects/`](#data) folder. Likewise for [file targets](https://books.ropensci.org/targets/data.html#external-files).
