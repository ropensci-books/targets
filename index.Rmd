...
This manual is a step-by-step user guide to [`targets`](https://github.com/ropensci/targets). It [walks through basic usage](#walkthrough), [outlines general best practices](#practice), dives deep into advanced features like [high-performance computing](#hpc), and [helps `drake` users transition to `targets`](#drake). See the [documentation website](https://wlandau.github.io/targets/index.html) for most other major resources, including [installation instructions](https://wlandau.github.io/targets/index.html#installation), links to [example projects](https://wlandau.github.io/targets/index.html#examples), and a [reference page with all user-side functions](https://wlandau.github.io/targets/reference/index.html). 
