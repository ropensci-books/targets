...
This manual is a step-by-step user guide to [`targets`](https://github.com/wlandau/targets). It [walks through basic usage](#walkthrough), [outlines general best practices](#practice), dives deep into advanced features like [high-performance computing](#hpc), and [helps `drake` users transition to `targets`](#drake). See the [documentation website](https://wlandau.github.io/targets/index.html) for most other major resources, including [installation instructions](https://wlandau.github.io/targets/index.html#installation), links to [example projects](https://wlandau.github.io/targets/index.html#examples), and a [reference page with all user-side functions](https://wlandau.github.io/targets/reference/index.html). 

## What about `drake`?

The [`drake`](https://github.com/ropensci/drake) is an older R-focused pipeline toolkit, and [`targets`](https://github.com/wlandau/targets) is [`drake`](https://github.com/ropensci/drake)'s long-term successor. There is a [special chapter](#drake) to explain why [`targets`](https://github.com/wlandau/targets) was created, what this means for [`drake`](https://github.com/ropensci/drake)'s future, advice for [`drake`](https://github.com/ropensci/drake) users transitioning to the [`targets`](https://github.com/wlandau/targets), and the main technical advantages of [`targets`](https://github.com/wlandau/targets) over [`drake`](https://github.com/ropensci/drake).
