...
To illustrate, consider the example pipeline below. It uses dynamic branching to generate random [spirographs](https://wjschne.github.io/spiro/index.html), borrowing code from [W. Joel Schneider](wjschne)'s [`spiro`](https://wjschne.github.io/spiro/index.html) package.^[The pipeline uses code borrowed from the [`spiro`](https://wjschne.github.io/spiro/index.html) package. The code in the `spirograph_points()` function is adapted from <https://github.com/wjschne/spiro/blob/87f73ec37ceb0a7a9d09856ada8ae28d587a2ebd/R/spirograph.R>
