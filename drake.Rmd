...
[`drake_plan()`](https://docs.ropensci.org/drake/reference/drake_plan.html) | [`tar_manifest()`](https://wlandau.github.io/targets/reference/tar_manifest.html), [`tarchetypes::tar_plan()`](https://wlandau.github.io/tarchetypes/reference/tar_plan.html)
...
[`drake_config()`](https://docs.ropensci.org/drake/reference/drake_config.html) | [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
...
[`drake_history()`](https://docs.ropensci.org/drake/reference/drake_history.html), [`recoverable()`](https://docs.ropensci.org/drake/reference/recoverable.html) | Unsupported in `targets`. Instead of trying to manage history and data recovery directly, [`targets`](https://github.com/wlandau/targets) maintains a much lighter/friendlier data store to make it easier to use external data versioning tools instead.
...
---|---
`targets` | `names` in [`tar_make()`](https://wlandau.github.io/targets/reference/tar_make.html) etc.
`envir` | `envir` in [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`verbose` | `reporter` in [`tar_make()`](https://wlandau.github.io/targets/reference/tar_make.html) etc.
`parallelism` | Choice of function: [`tar_make()`](https://wlandau.github.io/targets/reference/tar_make.html) vs [`tar_make_clustermq()`](https://wlandau.github.io/targets/reference/tar_make_clustermq.html) vs [`tar_make_future()`](https://wlandau.github.io/targets/reference/tar_make_future.html)
`jobs` | `workers` in [`tar_make_clustermq()`](https://wlandau.github.io/targets/reference/tar_make_clustermq.html) and [`tar_make_future()`](https://wlandau.github.io/targets/reference/tar_make_future.html)
`packages` | `packages` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`lib_loc` | `library` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`trigger` | `cue` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`caching` | `storage` and `retrieval` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`keep_going` | `error` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`memory_strategy` | `memory` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`garbage_collection` | `garbage_collection` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`template` | `resources` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`curl_handles` | `handle` element of `resources` argument of [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`format` | `format` in [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
...
---|---
`format` | `format` argument of [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`dynamic` | `pattern` argument of [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`transform` | [static branching functions in `tarchetypes`](https://wlandau.github.io/tarchetypes/reference/index.html#section-branching) such as [`tar_map()`](https://wlandau.github.io/tarchetypes/reference/tar_map.html) and [`tar_combine()`](https://wlandau.github.io/tarchetypes/reference/tar_combine.html)
`trigger` | `cue` argument of [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`hpc` | `deployment` argument of [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`resources` | `resources` argument of [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
`caching` | `storage` and `retrieval` arguments of [`tar_target()`](https://wlandau.github.io/targets/reference/tar_target.html) and  [`tar_option_set()`](https://wlandau.github.io/targets/reference/tar_option_set.html)
...
Thanks to the simplified data store and simplified internals, [`targets`](https://github.com/wlandau/targets) can automatically upload data to the Amazon S3 bucket of your choice. Simply configure [`aws.s3`](https://github.com/cloudyr/aws.s3), create a bucket, and select one of the AWS-powered storage formats. Then, [`targets`](https://github.com/wlandau/targets) will automatically upload the return values to the cloud.
...
Because the design of [`targets`](https://github.com/wlandau/targets) is fundamentally dynamic, users can create complicated dynamic branching patterns that are never going to be possible in `drake`. Below, target `z` creates six branches, one for each combination of `w` and tuple (`x`, `y`). The pattern `cross(w, map(x, y))` is equivalent to `tidyr::crossing(w, tidyr::nesting(x, y))`.
