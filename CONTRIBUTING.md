...
1. Prior to contribution, please propose your idea in a [new issue thread](https://github.com/ropensci-books/targets/issues) so you and the maintainer can define the intent and scope of your work.
...
* Describe your contribution in the project's [`NEWS.md`](https://github.com/ropensci-books/targets/blob/main/NEWS.md) file. Be sure to mention relevent GitHub issue numbers and your GitHub name as done in existing news entries.
* If you feel contribution is substantial enough for official author or contributor status, please add yourself as an author in the  [`index.Rmd`](https://github.com/ropensci-books/targets/blob/main/index.Rmd) file and [`DESCRIPTION](https://github.com/ropensci-books/targets/blob/main/DESCRIPTION) file.
