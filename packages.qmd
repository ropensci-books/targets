...
If you use [`renv`](https://rstudio.github.io/renv/), consider disabling the slowest startup checks so your pipelines and [workers](#hpc) start faster. You can read about RSPM integration and the synchronized check options at <https://rstudio.github.io/renv/reference/config.html>. Then if you are sure you will not need these checks, you can disable them with the following lines in your user-level `.Renviron` file:
