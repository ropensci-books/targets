...
Optionally set the `root.dir` `knitr` option to invoke all the code chunks from the directory of your choice. This gives you control over where `targets` writes all its scripts and output data.
