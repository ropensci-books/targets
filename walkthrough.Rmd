...
This chapter walks through a minimal example of a [`targets`](https://github.com/ropensci/targets)-powered data analysis project. The source code is available [here](https://github.com/ropensci/targets-minimal), and it has a free [RStudio Cloud workspace](https://rstudio.cloud/project/1430691) where you can try the code in your web browser. The [documentation website](https://wlandau.github.io/targets/index.html#examples) links to other examples.
