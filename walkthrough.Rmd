...
This chapter walks through a minimal example of a [`targets`](https://github.com/wlandau/targets)-powered data analysis project. The source code is available [here](https://github.com/wlandau/targets-minimal), and it has a free [RStudio Cloud workspace](https://rstudio.cloud/project/1430691) where you can try the code in your web browser. The [documentation website](https://wlandau.github.io/targets/index.html#examples) links to other examples.
...
Whereas files `raw_data.csv` and `functions.R` are typical user-defined components of a [project-oriented workflow](https://rstats.wtf/project-oriented-workflow.html), `_targets.R` file is special. Every [`targets`](https://github.com/wlandau/targets) workflow needs a file called `_targets.R` in the project's [root directory](https://martinctc.github.io/blog/rstudio-projects-and-working-directories-a-beginner%27s-guide/). Functions [`tar_script()`](https://wlandau.github.io/targets/reference/tar_script.html) and [`tar_edit()`](https://wlandau.github.io/targets/reference/tar_edit.html) can help you create one. Ours looks looks like this:
