...
This chapter shares guidance to help you ask effective questions.
...
Any response will be guesswork, and guesses about computer code are usually wrong.
...
1. Be runnable by anyone else. For example, do not reference files that only you can access.
...
GitHub makes it easy to search for and link to public discussions. Not only does this help users solve their own problems, it also helps the maintainer avoid repetition.
So please use public discussions instead of private emails, instant messages, or mentions on social media.
