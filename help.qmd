...
Anyone can find and link to a public GitHub discussion, and the ability to search and cross-reference existing material helps users solve their own problems and helps the maintainer avoid repetition. For this reason, please do not send private emails, instant messages, or mentions on social media.
