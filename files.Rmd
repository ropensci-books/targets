...
R Markdown reports are specialized targets to document the upstream work your pipeline already did. The code chunks should be minimal: just some calls to `tar_read()` and `tar_load()` to load dependencies. For maximum efficiency, modularity, and readability, most of the content should be prose.
