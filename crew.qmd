...
2. Run the pipeline with a simple [`tar_make()`](https://docs.ropensci.org/targets/reference/tar_make.html) (not [`tar_make_clustermq()`](https://docs.ropensci.org/targets/reference/tar_make_clustermq.html) or [`tar_make_future()`](https://docs.ropensci.org/targets/reference/tar_make_future.html)).
